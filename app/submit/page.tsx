...
export const metadata: Metadata = {
  ...
  description: "Submit an Irvine business listing to Irvine Index for the local directory MVP."
};
  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 max-w-2xl text-lg leading-8 text-ink/72">
        This MVP saves submissions to a local JSON file for review. No payments, accounts, or paid APIs are included.
      </p>
      <div className="mt-8">
        <SubmitBusinessForm />
      </div>
